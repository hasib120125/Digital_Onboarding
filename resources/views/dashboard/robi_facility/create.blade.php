    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="box box-info">
                ...
                @endif
                <!-- form start -->    
                {!! Form::open(['route' => 'robi-facility-save','method' => 'POST', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                    <div class="box-body">
        ...
        <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Our Facilities List</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                               @foreach ($robi_facilities as $robi_facilitie)
                               <tr>
                                    <td>{{$robi_facilitie->id}}</td>
                                    <td>{{$robi_facilitie->file_type}}</td>
                                    <td>{!! htmlspecialchars_decode($robi_facilitie->message) !!}</td>
                                    <td><a href="{{route('robi-facility-edit', $robi_facilitie->id )}}" class="btn btn-info">Edit</a></td>
                                </tr>
                               @endforeach
                            </tbody>
