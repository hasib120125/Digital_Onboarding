    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="box box-info">
                ...
                @endif
                <!-- form start -->    
                {!! Form::open(['route' => 'ceo-message-save','method' => 'POST', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('name', null, array('placeholder' => 'Enter CEO Name','class' => 'form-control')) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::file('photo', null, array('placeholder' => 'Add Files','class' => 'form-control')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    <td>{{$message->id}}</td>
                                    <td>{{$message->file_type}}</td>
                                    <td>{!! htmlspecialchars_decode($message->message) !!}</td>
                                    <td><a href="{{route('ceo-message-edit',$message->id)}}" class="btn btn-info">Edit</a></td>
                                </tr>
                               @endforeach
                            </tbody>
                            <tfoot>
