...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="box box-info">
            ...
            @endif
            <!-- form start -->    
            {!! Form::open(['route' => ['guide-line-principle-update', $guideline->id],'method' => 'PATCH', 'class' => 'form-horizontal' , 'enctype' => 'multipart/form-data']) !!}
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="file-name">{{$guideline->file_location}}</span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::textarea('message', $guideline->message, array('placeholder' => 'Add Message','class' => 'form-control', 'id' => 'summary-ckeditor')) !!}
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
                <div class="box-footer">
                    ...
                    <a href="{{route('guide-line-principle')}}" class="btn btn-info pull-left">Back</a>
                </div>
                <!-- /.box-footer -->
            {!! Form::close() !!}
        </div>
