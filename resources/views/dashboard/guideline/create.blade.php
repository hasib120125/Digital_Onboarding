    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="box box-info">
                ...
                @endif
                <!-- form start -->    
                {!! Form::open(['route' => 'guide-line-principle-save','method' => 'POST', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                    <div class="box-body">
        ...
        <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Guideline List</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>{!! htmlspecialchars_decode($guideline->message) !!}</td>
                                    <td><a href="{{route('guide-line-principle-edit', $guideline->id )}}" class="btn btn-info">Edit</a></td>
                                </tr>
                               @endforeach
                            </tbody>
