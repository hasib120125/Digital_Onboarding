...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="box box-info">
            ...
            @endif
            <!-- form start -->    
            {!! Form::open(['route' => ['code-of-conduct-update', $code_of_conducts->id],'method' => 'PATCH', 'class' => 'form-horizontal' , 'enctype' => 'multipart/form-data']) !!}
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="file-name">{{$code_of_conducts->file_location}}</span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::textarea('message', $code_of_conducts->message, array('placeholder' => 'Add Message','class' => 'form-control', 'id' => 'summary-ckeditor')) !!}
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
                <div class="box-footer">
                    ...
                    <a href="{{route('code-of-conduct')}}" class="btn btn-info pull-left">Back</a>
                </div>
                <!-- /.box-footer -->
            {!! Form::close() !!}
        </div>
