    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="box box-info">
                ...
                @endif
                <!-- form start -->    
                {!! Form::open(['route' => 'robi-culture-save','method' => 'POST', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                    <div class="box-body">
        ...
        <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Our Culture List</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                               @foreach ($robi_cultures as $robi_culture)
                               <tr>
                                    <td>{{$robi_culture->id}}</td>
                                    <td>{{$robi_culture->file_type}}</td>
                                    <td>{!! htmlspecialchars_decode($robi_culture->message) !!}</td>
                                    <td><a href="{{route('robi-culture-edit', $robi_culture->id )}}" class="btn btn-info">Edit</a></td>
                                </tr>
                               @endforeach
                            </tbody>
