...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="box box-info">
            ...
            @endif
            <!-- form start -->    
            {!! Form::open(['route' => ['robi-culture-update', $robi_cultures->id],'method' => 'PATCH', 'class' => 'form-horizontal' , 'enctype' => 'multipart/form-data']) !!}
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="file-name">{{$robi_cultures->file_location}}</span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::textarea('message', $robi_cultures->message, array('placeholder' => 'Add Message','class' => 'form-control', 'id' => 'summary-ckeditor')) !!}
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
                <div class="box-footer">
                    ...
                    <a href="{{route('robi-culture')}}" class="btn btn-info pull-left">Back</a>
                </div>
                <!-- /.box-footer -->
            {!! Form::close() !!}
        </div>
