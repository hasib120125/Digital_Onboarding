    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="box box-info">
                ...
                @endif
                <!-- form start -->    
                {!! Form::open(['route' => 'it-guideline-save','method' => 'POST', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                    <div class="box-body">
        ...
        <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">IT Guideline List</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                               @foreach ($it_guidelines as $it_guideline)
                               <tr>
                                    <td>{{$it_guideline->id}}</td>
                                    <td>{{$it_guideline->file_type}}</td>
                                    <td>{!! htmlspecialchars_decode($it_guideline->message) !!}</td>
                                    <td><a href="{{route('it-guideline-edit', $it_guideline->id )}}" class="btn btn-info">Edit</a></td>
                                </tr>
                               @endforeach
                            </tbody>
